  ...
  return (
    <div className='nav-item absolute right-1 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96'>
      <div className='flex justify-between items-center'>
        ...
        <button type='button' className='text-xl' onClick={closeClick}><MdOutlineCancel/></button>
      </div>
      <div className='flex gap-5 items-center mt-6 border-color border-b-1 pb-6'>
        ...
        <div>
          ...
          <p className='text-gray-500 text-sm font-semibold dark:text-gray-400'>johndoe@example.com</p>
        </div>
      </div>
      <div>
      ...
      <div className='mt-5'><Button color='white' bgColor={currentColor} text='Logout' borderRadius='10px' width='full'/>
      </div>
    </div>
